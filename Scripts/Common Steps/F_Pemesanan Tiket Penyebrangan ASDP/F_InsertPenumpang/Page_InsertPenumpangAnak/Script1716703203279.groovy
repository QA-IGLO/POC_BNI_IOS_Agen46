...
Mobile.waitForElementPresent(findTestObject('Pemesanan Tiket/Ferizy/Informasi Penumpang/Folder_FieldPenumpang/select_Penumpang1Anak'), 
    10)

Mobile.takeScreenshotAsCheckpoint('Sebelum Insert Penumpang Anak', FailureHandling.STOP_ON_FAILURE)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Pemesanan Tiket/Ferizy/Informasi Penumpang/Folder_FieldPenumpang/select_Penumpang1Anak'), 5)

Mobile.delay(20, FailureHandling.STOP_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Pemesanan Tiket/Ferizy/Informasi Penumpang/Titel/field_Titel'), 15)
...
Mobile.setText(findTestObject('Pemesanan Tiket/Ferizy/Informasi Penumpang/field_Namalengkap'), findTestData('Data Pemesanan Tiket Penyeberangan/Informasi Penumpang Anak').getValue(
        1, 1), 0)
...
Mobile.setText(findTestObject('Pemesanan Tiket/Ferizy/Jadwal/input_Date'), findTestData('Data Pemesanan Tiket Penyeberangan/Informasi Penumpang Anak').getValue(
        2, 1), 5)
...
Mobile.takeScreenshotAsCheckpoint('Berhasil Insert Penumpang Anak', FailureHandling.STOP_ON_FAILURE)
