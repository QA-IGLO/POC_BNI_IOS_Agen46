...
Mobile.waitForElementPresent(findTestObject('Pemesanan Tiket/Ferizy/Informasi Penumpang/Folder_FieldPenumpang/select_Penumpang2Dewasa'), 
    10)

Mobile.takeScreenshotAsCheckpoint('Sebelum Insert Penumpang Dewasa 2', FailureHandling.STOP_ON_FAILURE)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Pemesanan Tiket/Ferizy/Informasi Penumpang/Folder_FieldPenumpang/select_Penumpang2Dewasa'), 10)

Mobile.delay(20, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Pemesanan Tiket/Ferizy/Informasi Penumpang/Titel/field_Titel'), 5)
...
Mobile.takeScreenshotAsCheckpoint('Berhasil Insert Penumpang Dewasa 2', FailureHandling.STOP_ON_FAILURE)
