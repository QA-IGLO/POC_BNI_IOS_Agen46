...
CustomKeywords.'utilsKeywordPackage.UtilsKeyword.swipeDown_DropdownPenumpang'(3)
...
Mobile.checkElement(findTestObject('Pemesanan Tiket/Ferizy/Informasi Penumpang/check_VerifyData3'), 0)
