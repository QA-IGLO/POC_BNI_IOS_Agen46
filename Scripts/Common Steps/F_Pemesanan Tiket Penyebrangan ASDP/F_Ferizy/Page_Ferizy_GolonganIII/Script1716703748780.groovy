...
CustomKeywords.'Ferizy.select_GolonganKendaraan'('Golongan III')
...
Mobile.tap(findTestObject('Pemesanan Tiket/Ferizy/field_Jam'), 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('Pemesanan Tiket/Ferizy/Penumpang/addAnak'), 0)
