...
Mobile.setText(findTestObject('Register Online/field_NamaBelakang'), findTestData('Approval Registrasi').getValue(1, 2), 
    0)
...
Mobile.setText(findTestObject('Register Online/field_KodeRegistrasi'), findTestData('Approval Registrasi').getValue(2, 2), 
    0)
