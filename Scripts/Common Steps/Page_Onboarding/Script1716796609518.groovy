...
Mobile.waitForElementPresent(findTestObject('Register Online/btn_Masuk'), 10)

Mobile.takeScreenshotAsCheckpoint('Page Onboarding ', FailureHandling.STOP_ON_FAILURE)
