...
WebUI.callTestCase(findTestCase('Common Steps/F_Pemesanan Tiket Penyebrangan ASDP/F_Ferizy/Page_Ferizy_GolonganI'), [:], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Common Steps/F_Pemesanan Tiket Penyebrangan ASDP/F_VerifikasiPenumpang/Page_VerifikasiPenumpang-AGN0001-002'), 
    [:], FailureHandling.STOP_ON_FAILURE)
