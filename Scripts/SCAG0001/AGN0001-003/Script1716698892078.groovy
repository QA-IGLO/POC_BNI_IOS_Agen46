...
WebUI.callTestCase(findTestCase('Common Steps/F_Pemesanan Tiket Penyebrangan ASDP/F_Ferizy/Page_Ferizy_GolonganII'), [:], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Common Steps/F_Pemesanan Tiket Penyebrangan ASDP/F_VerifikasiPenumpang/Page_VerifikasiPenumpang-AGN0001-003'), 
    [:], FailureHandling.STOP_ON_FAILURE)
