...
WebUI.callTestCase(findTestCase('Common Steps/F_Pemesanan Tiket Penyebrangan ASDP/F_Ferizy/Page_Ferizy_GolonganIII'), [:], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Common Steps/F_Pemesanan Tiket Penyebrangan ASDP/F_InsertPenumpang/Page_InsertPenumpangAnak'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Common Steps/F_Pemesanan Tiket Penyebrangan ASDP/F_VerifikasiPenumpang/Page_VerifikasiPenumpang-AGN0001-004'), 
    [:], FailureHandling.STOP_ON_FAILURE)
