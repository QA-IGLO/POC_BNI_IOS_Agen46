...
CustomKeywords.'BlockService.insertServiceBlock'('tfInquiry')
...
Mobile.tap(findTestObject('Buka Rekening BNI Pandai/subMenu_TransferAntarBank'), 0)
...
CustomKeywords.'BlockService.deleteServiceBlock'('tfInquiry')
