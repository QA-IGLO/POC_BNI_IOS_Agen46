...
CustomKeywords.'BlockService.insertServiceBlock'('setorTunaiInquiry')
...
WebUI.callTestCase(findTestCase('Common Steps/F_Buka Rekening BNI Pandai/F_SubMenu_LayananKeuangan/Page_LayananKeuangan_SetorTunai'), 
...
CustomKeywords.'BlockService.deleteServiceBlock'('setorTunaiInquiry')
